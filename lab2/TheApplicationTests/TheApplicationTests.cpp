...
BOOST_AUTO_TEST_SUITE(operator_plus)
	...
	BOOST_AUTO_TEST_CASE(simple_with_zero)
	{
...
{
	BOOST_CHECK_EQUAL(CLongNumber("75245235984") - CLongNumber("951753"), CLongNumber("75244284231"));
}
BOOST_AUTO_TEST_SUITE_END()
...
BOOST_AUTO_TEST_SUITE(operator_multiply)
	...
	BOOST_AUTO_TEST_CASE(big_numbers_2)
	{
		BOOST_CHECK_EQUAL(CLongNumber("75245235984") * CLongNumber("951753"), CLongNumber("71614879083479952"));
	}
...
BOOST_AUTO_TEST_CASE(very_big_2)
{
	BOOST_CHECK_EQUAL(CLongNumber("75245235984") / CLongNumber("951753"), CLongNumber("79059"));
}

BOOST_AUTO_TEST_CASE(very_big_3)
{
	BOOST_CHECK_EQUAL(CLongNumber("222222222222222222222222222222222222222222222222222222") / CLongNumber("22"), CLongNumber("10101010101010101010101010101010101010101010101010101"));
	
}
BOOST_AUTO_TEST_CASE(very_big_4)
{
	BOOST_CHECK_EQUAL(CLongNumber("1000000000000000") + CLongNumber("100000000000000"), CLongNumber("2000000000000000"));
}
BOOST_AUTO_TEST_SUITE_END()